...
When we cross-tabulate the variables, we can see a negative correlation between the number of extra-marital realtions and how people rate their marriage. There's also some correlation between extra-marital affairs and years of marriage and negative correaltion with religiousness. Next, let's so a regression analysis on these pairs.  
...
p1 <-ggplot(affairs, aes(x = rate, y = nbaffairs, col=sex)) +
  ...
  ggtitle("Experienced Happiness in Marriage versus Number of Extra-marital Affairs")+
...
p1 <-ggplot(affairs, aes(x = ym, y = nbaffairs, col=sex)) +
  geom_point() + geom_smooth(method="lm") + 
  ggtitle("Number of Years Married versus Number of Extra-marital Affairs")+
  theme(plot.title = element_text(hjust = 0.5,size=16,face='bold'),
        axis.title= element_text(hjust = 0.5,size=12))
p1
```
...
p1 <-ggplot(affairs, aes(x = religious, y = nbaffairs, col=sex)) +
  geom_point() + geom_smooth(method="lm") + 
  ggtitle("Religiousness versus Number of Extra-marital Affairs")+
  theme(plot.title = element_text(hjust = 0.5,size=16,face='bold'),
        axis.title= element_text(hjust = 0.5,size=12))
p1
```
